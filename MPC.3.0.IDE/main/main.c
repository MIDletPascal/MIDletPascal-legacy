/*
        ...
        MidletPascal-compiler 3.0.IDE (mp3CC.exe)
        ...
        MPC.3.0.IDE:
            Javier Santo Domingo (j-a-s-d@users.sourceforge.net)
                ...
                and bugfixes (real numbers parsing, etc)
...
void ShowHelp()
{
    sprintf(msgstr,
    "-------------------------------------------------------------------------\n"
    "MIDletPascal 3.0 Compiler\n"
    "Version: MPC.3.0.IDE (Niksa Orlic & Artem & Javier Santo Domingo)\n"
    "-------------------------------------------------------------------------\n"
    "usage: mp3cc\n"
    "\t-s\"<source_filename>\"\n"
    "\t-o\"<output_path>\"\n"
