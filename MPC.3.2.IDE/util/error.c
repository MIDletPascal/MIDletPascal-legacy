...
char *msg(int i){
	...
	case 443: return "a value cannot be asigned to an array. This is a current limitation of MIDletPascal";
	...
	case 446: return "arrays in records (\'%s\') are not yet implemented. This is a current limitation of MIDletPascal";
	...
	case 460: return "keyword \'%s\' is not allowed here. This is a current limitation of MIDletPascal";
	}
}
