...
char *msg(int i){
	...
	case 11: return "Internal error #011 (identifier_duplicate)";
	case 12: return "Internal error #012 (create_record_class)";
	case 13: return "Internal error #013 (get_field_descriptor)";
	case 14: return "Internal error #014 (initialize_variable)";
	case 15: return "Internal error #015 (create_variable_bytecode)";
	case 16: return "Internal error #016 (write_constant_pool)";
	case 17: return "Internal error #017 (write_method)";
	case 18: return "Internal error #018 (cp_add_long/double)";
	case 19: return "Internal error #019 ()";
	case 20: return "Internal error #020 (RD_proc_block)";
	case 21: return "Internal error #021 (main)";
	case 22: return "Internal error #022 ()";
	case 23: return "Internal error #023 (initialize_variable)";
	case 24: return "Internal error #024 (replace_aaload_instruction)";
	case 25: return "Internal error #025 (create_std_function_code)";
	...
	//case 460: return "ASM-LABEL %s not found";
	//case 461: return "ASM-LABEL %s already defined";
	case 460: return "ASM-LABEL \'%d\' (offs:%d) not found";
	case 461: return "ASM-LABEL \'%d\' (offs:%d) already defined";
	case 462: return "ASM-LABEL \'%d\' (offs:%d) tableswitch / loookupswitch";
	}
	return "???\'%s\'???\'%s\'???";
}
